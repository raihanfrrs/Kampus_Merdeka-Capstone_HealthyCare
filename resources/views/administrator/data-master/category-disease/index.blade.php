...
<div class="card mb-4">
    <div class="card-header">
        ...
        Master Category Disease
        <a href="/category-disease/create" class="btn btn-secondary btn-sm float-end">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="me-1">
        ...
        <table id="datatablesSimple">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->category }}</td>
                    <td>
                        <form action="/category-disease/{{ $item->id }}" method="post">
                            @csrf
                            @method('delete')
                            <a href="/category-disease/{{ $item->id }}/edit" class="btn btn-warning btn-sm text-white">
